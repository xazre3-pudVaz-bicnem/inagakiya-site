...
const webPageJsonLd = {
  "@context": "https://schema.org",
  "@type": "WebPage",
  name: "香典返しについて｜時期・品物・のし・挨拶状｜葛飾区 稲垣屋葬儀店",
  description:
    "香典返しの時期・品物の選び方・のしの書き方・挨拶状の文例について。葛飾区の稲垣屋葬儀店が丁寧にご説明します。",
  url: "https://www.inagakiyasougiten.com/support/kouden-return",
  breadcrumb: {
    "@type": "BreadcrumbList",
    itemListElement: [
      { "@type": "ListItem", position: 1, name: "ホーム", item: "https://www.inagakiyasougiten.com" },
      { "@type": "ListItem", position: 2, name: "葬儀サポート", item: "https://www.inagakiyasougiten.com/support" },
      { "@type": "ListItem", position: 3, name: "香典返しについて", item: "https://www.inagakiyasougiten.com/support/kouden-return" },
    ],
  },
};
