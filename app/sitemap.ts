...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const entries: { url: string; priority: number; freq?: MetadataRoute.Sitemap[number]["changeFrequency"] }[] = [
    ...
    { url: "/flow/after-death", priority: 0.78, freq: "monthly" },
    ...
    // Support
    { url: "/support", priority: 0.78, freq: "monthly" },
    { url: "/support/first-time", priority: 0.75, freq: "monthly" },
    { url: "/support/parent-funeral", priority: 0.75, freq: "monthly" },
    { url: "/support/small-funeral", priority: 0.75, freq: "monthly" },
    { url: "/support/no-religion", priority: 0.73, freq: "monthly" },
    { url: "/support/preparing", priority: 0.75, freq: "monthly" },
    { url: "/support/after-funeral", priority: 0.75, freq: "monthly" },
    { url: "/support/documents", priority: 0.73, freq: "monthly" },
    ...
    // Other
    { url: "/consultation", priority: 0.88, freq: "monthly" },
    { url: "/faq", priority: 0.85, freq: "monthly" },
