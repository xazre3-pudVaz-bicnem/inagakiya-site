...
const webPageJsonLd = {
  "@context": "https://schema.org",
  "@type": "WebPage",
  name: "葛飾区でシンプルな葬儀をお考えの方へ",
  description:
    "葛飾区でシンプルな葬儀をお考えの方へ。火葬式（直葬）・一日葬の特徴と費用を稲垣屋葬儀店が丁寧にご説明します。",
  url: "https://www.inagakiyasougiten.com/katsushika-funeral/simple-funeral",
  breadcrumb: {
    "@type": "BreadcrumbList",
    itemListElement: [
      { "@type": "ListItem", position: 1, name: "ホーム", item: "https://www.inagakiyasougiten.com" },
      { "@type": "ListItem", position: 2, name: "葛飾区の葬儀", item: "https://www.inagakiyasougiten.com/katsushika-funeral" },
      { "@type": "ListItem", position: 3, name: "シンプルな葬儀", item: "https://www.inagakiyasougiten.com/katsushika-funeral/simple-funeral" },
    ],
  },
};
