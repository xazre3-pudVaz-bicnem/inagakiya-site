...
export const metadata: Metadata = {
  title: "東金町の葬儀｜葛飾区 稲垣屋葬儀店",
  description:
    "東金町で葬儀をお考えの方へ。葛飾区の稲垣屋葬儀店が家族葬・一日葬・火葬式・区民葬儀に対応。24時間365日対応。",
  alternates: {
    canonical: "https://www.inagakiyasougiten.com/area/higashi-kanamachi",
  },
};

const faqs = [
  {
    q: "東金町で急にご逝去があった場合、何時でも連絡できますか？",
    a: "はい、24時間365日いつでもご連絡いただけます。深夜・早朝・休日を問わず、すぐに対応いたします。急なご逝去の際は、まずお電話（03-3690-0870）ください。東金町のご自宅や病院へも速やかにお迎えに参ります。",
  },
  {
    q: "東金町から稲垣屋葬儀店まではどのくらいですか？",
    a: "稲垣屋葬儀店は葛飾区堀切6-33-4にあります。東金町からは車で20〜30分ほどの距離です。葛飾区北東部に位置する東金町からも、ご連絡いただければ速やかにお伺いいたします。",
  },
  {
    q: "東金町での家族葬の費用はどのくらいですか？",
    a: "費用はご参列者の規模・プランの内容・ご利用の斎場などにより変わります。まずは無料のお見積もりをご利用ください。東金町周辺の近隣の斎場についてもご案内できますので、お気軽にご相談ください。",
  },
  {
    q: "東金町でも区民葬儀制度は使えますか？",
    a: "はい、ご利用いただけます。葛飾区の区民葬儀制度は、故人または喪主が葛飾区に住民票をお持ちの方が対象です。東金町にお住まいの方も対象となります。稲垣屋葬儀店は区民葬儀取扱店として登録しています。",
  },
];
...
const webPageJsonLd = {
  ...
  "@type": "WebPage",
  name: "東金町の葬儀｜葛飾区 稲垣屋葬儀店",
  description: "東金町で葬儀をお考えの方へ。葛飾区の稲垣屋葬儀店が家族葬・一日葬・火葬式・区民葬儀に対応。24時間365日対応。",
  url: "https://www.inagakiyasougiten.com/area/higashi-kanamachi",
  breadcrumb: {
    "@type": "BreadcrumbList",
    itemListElement: [
      { "@type": "ListItem", position: 1, name: "ホーム", item: "https://www.inagakiyasougiten.com" },
      { "@type": "ListItem", position: 2, name: "葛飾区 地域別葬儀情報", item: "https://www.inagakiyasougiten.com/area" },
      { "@type": "ListItem", position: 3, name: "東金町の葬儀", item: "https://www.inagakiyasougiten.com/area/higashi-kanamachi" },
    ],
  },
};

export default function HigashiKanamachiPage() {
  return (
    <>
      <script
      ...
      />
      <Breadcrumb
        items={[{ label: "対応エリア", href: "/area" }, { label: "東金町の葬儀" }]}
      />
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <FadeInUp>
            <p className="text-[#4a4a4a] text-base md:text-lg leading-loose mb-6">
              東金町は葛飾区の北東部に位置し、JR常磐線・京成金町線「金町」駅の東側に広がる住宅地です。水元公園にも近く、緑豊かな環境の中に落ち着いた住まいが並ぶ、穏やかな雰囲気のエリアです。埼玉県との県境にも近く、葛飾区の外れに位置することから、葬儀社をどこに頼めばよいか迷われる方もいらっしゃいます。
            </p>
            <p className="text-[#4a4a4a] text-base md:text-lg leading-loose mb-6">
              稲垣屋葬儀店は、葛飾区堀切6-33-4を拠点とし、葛飾区全域に対応しています。東金町のご家族からのご連絡も、24時間365日いつでも承り、速やかにお伺いします。明治11年頃の創業以来、葛飾区の各エリアで数多くのご葬儀をお手伝いしてきた実績があります。
            </p>
            <p className="text-[#4a4a4a] text-base md:text-lg leading-loose mb-6">
              東金町周辺にお住まいの方からは、「どの斎場を使えばよいか」「遠くても来てもらえるか」といったご相談もよくいただきます。稲垣屋葬儀店では、葛飾区内の近隣の斎場への対応も承っており、葬祭ディレクター1級の資格を持つスタッフが最適なプランをご提案いたします。
            </p>
            <p className="text-[#4a4a4a] text-base leading-loose">
              家族葬・一日葬・火葬式・一般葬・区民葬儀と、ご家族の状況に合わせたプランをご用意しています。葛飾区民の方は区民葬儀制度もご活用いただけます。事前相談・お見積もりはすべて無料です。どうぞお気軽にご相談ください。
            </p>
          </FadeInUp>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <StaggerContainer className="divide-y divide-[#e8ddf4]">
            {[
              ...
              { href: "/area/kanamachi-josui", label: "金町・浄水場周辺の葬儀" },
            ].map((link) => (
