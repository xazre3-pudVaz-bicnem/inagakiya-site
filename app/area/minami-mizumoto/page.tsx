...
export const metadata: Metadata = {
  title: "南水元の葬儀｜葛飾区 稲垣屋葬儀店",
  description:
    "南水元で葬儀をお考えの方へ。葛飾区の稲垣屋葬儀店が家族葬・一日葬・火葬式・区民葬儀に対応。24時間365日対応。",
  alternates: {
    canonical: "https://www.inagakiyasougiten.com/area/minami-mizumoto",
  },
};

const faqs = [
  {
    q: "南水元で急にご逝去があった場合、何時でも連絡できますか？",
    a: "はい、24時間365日いつでもご連絡いただけます。深夜・早朝・休日を問わず対応しております。南水元のご自宅や病院へも速やかにお迎えに参ります。まずはお電話（03-3690-0870）ください。",
  },
  {
    q: "南水元から稲垣屋葬儀店まではどのくらいですか？",
    a: "稲垣屋葬儀店は葛飾区堀切6-33-4にあります。南水元からは車で25〜35分ほどの距離です。ご連絡いただければ速やかにお伺いいたします。",
  },
  {
    q: "南水元での家族葬の費用はどのくらいですか？",
    a: "費用はご参列者の人数・プランの内容・ご利用の斎場などによって異なります。事前のお見積もりは無料です。費用の内訳も含めて丁寧にご説明しますので、まずはお気軽にご相談ください。",
  },
  {
    q: "南水元でも区民葬儀制度は使えますか？",
    a: "はい、ご利用いただけます。葛飾区の区民葬儀制度は、故人または喪主が葛飾区に住民票をお持ちの方が対象です。南水元にお住まいの方も対象となります。稲垣屋葬儀店は葛飾区の区民葬儀取扱店として登録しています。",
  },
];
...
const webPageJsonLd = {
  ...
  "@type": "WebPage",
  name: "南水元の葬儀｜葛飾区 稲垣屋葬儀店",
  description: "南水元で葬儀をお考えの方へ。葛飾区の稲垣屋葬儀店が家族葬・一日葬・火葬式・区民葬儀に対応。24時間365日対応。",
  url: "https://www.inagakiyasougiten.com/area/minami-mizumoto",
  breadcrumb: {
    "@type": "BreadcrumbList",
    itemListElement: [
      { "@type": "ListItem", position: 1, name: "ホーム", item: "https://www.inagakiyasougiten.com" },
      { "@type": "ListItem", position: 2, name: "葛飾区 地域別葬儀情報", item: "https://www.inagakiyasougiten.com/area" },
      { "@type": "ListItem", position: 3, name: "南水元の葬儀", item: "https://www.inagakiyasougiten.com/area/minami-mizumoto" },
    ],
  },
};

export default function MinamiMizumotoPage() {
  return (
    <>
      <script
      ...
      />
      <Breadcrumb
        items={[{ label: "対応エリア", href: "/area" }, { label: "南水元の葬儀" }]}
      />
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <FadeInUp>
            <p className="text-[#4a4a4a] text-base md:text-lg leading-loose mb-6">
              南水元は、葛飾区北部の水元地区の南側に位置する住宅地です。水元公園の緑豊かな環境に近く、穏やかな住環境の中で暮らすご家族が多いエリアです。金町や亀有などの主要駅からも車でアクセスでき、葛飾区内の生活圏の一部を形成しています。
            </p>
            <p className="text-[#4a4a4a] text-base md:text-lg leading-loose mb-6">
              稲垣屋葬儀店は、葛飾区堀切6-33-4を拠点とする地域密着の葬儀社です。明治11年頃の創業以来、葛飾区全域の皆様のご葬儀をお手伝いしてきました。南水元エリアのご家族からのご連絡も、24時間365日いつでも承り、速やかにお伺いします。
            </p>
            <p className="text-[#4a4a4a] text-base md:text-lg leading-loose mb-6">
              「突然のことで、どこに電話すればよいか」「先々のことを考えて事前に相談しておきたい」といったどんな状況でも、稲垣屋葬儀店にお電話いただければ、葬祭ディレクター1級の資格を持つスタッフが丁寧に対応いたします。費用のご不安も、葬儀形式の選択も、ご家族のペースに合わせてご説明いたします。
            </p>
            <p className="text-[#4a4a4a] text-base leading-loose">
              家族葬・一日葬・火葬式・一般葬・区民葬儀と、ご家族の状況に合わせた多様なプランをご用意しています。葛飾区民の方は区民葬儀制度もご利用いただけます。事前相談・お見積もりはすべて無料です。
            </p>
          </FadeInUp>
