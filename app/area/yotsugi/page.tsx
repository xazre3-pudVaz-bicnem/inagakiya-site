...
export const metadata: Metadata = {
  title: "四つ木で葬儀のご相談なら稲垣屋葬儀店｜葛飾区の地域密着葬儀社",
  description:
    "葛飾区四つ木・四ツ木周辺で葬儀をご検討の方へ。稲垣屋葬儀店は四つ木エリアにも対応した地域密着の葬儀社です。24時間365日対応。",
  alternates: { canonical: "https://www.inagakiyasougiten.com/area/yotsugi" },
};

const faqs = [
  {
    q: "四つ木から稲垣屋葬儀店まではどのくらいかかりますか？",
    a: "稲垣屋葬儀店は葛飾区堀切6-33-4にあります。四つ木エリアからは車で10分前後の距離です。京成押上線四ツ木駅周辺からもスムーズにお伺いできますので、ご連絡をいただければ迅速に対応いたします。",
  },
  {
    q: "四つ木で葬儀の事前相談はできますか？",
    a: "はい、事前相談は無料で承っております。「どんな葬儀にすればよいか」「四ツ木斎場を利用する場合の流れを知りたい」など、どんなことでもお気軽にお電話（03-3690-0870）またはお問い合わせフォームよりご連絡ください。",
  },
  {
    q: "四つ木の方でも区民葬儀は利用できますか？",
    a: "はい、ご利用いただけます。区民葬儀は葛飾区民の方が対象の制度です。四つ木にお住まいの方も対象となります。稲垣屋葬儀店は葛飾区の区民葬儀取扱店として登録しておりますので、詳しくはお気軽にお問い合わせください。",
  },
  {
    q: "四つ木で急な葬儀にも対応していますか？",
...
const webPageJsonLd = {
  ...
  "@type": "WebPage",
  name: "四つ木で葬儀のご相談なら稲垣屋葬儀店｜葛飾区の地域密着葬儀社",
  description: "葛飾区四つ木・四ツ木周辺で葬儀をご検討の方へ。稲垣屋葬儀店は四つ木エリアにも対応した地域密着の葬儀社です。24時間365日対応。",
  url: "https://www.inagakiyasougiten.com/area/yotsugi",
  breadcrumb: {
    "@type": "BreadcrumbList",
    itemListElement: [
      { "@type": "ListItem", position: 1, name: "ホーム", item: "https://www.inagakiyasougiten.com" },
      { "@type": "ListItem", position: 2, name: "葛飾区 地域別葬儀情報", item: "https://www.inagakiyasougiten.com/area" },
      { "@type": "ListItem", position: 3, name: "四つ木から見た稲垣屋葬儀店", item: "https://www.inagakiyasougiten.com/area/yotsugi" },
    ],
  },
};

export default function YotsugiPage() {
  return (
    <>
      <script
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <FadeInUp>
            <p className="text-[#4a4a4a] text-base md:text-lg leading-loose mb-6">
              京成押上線四ツ木駅を中心に広がる四つ木（四ツ木）エリアは、荒川と中川に挟まれた葛飾区南西部の住宅地です。下町らしい温かみのある町並みが続き、長年この地に住み続けてきた方も多くいらっしゃいます。近年は再開発も進みながらも、地域のつながりを大切にした生活が営まれているエリアです。
            </p>
            <p className="text-[#4a4a4a] text-base md:text-lg leading-loose mb-6">
              四つ木エリアには、葛飾区が管理・運営する公共の斎場「葛飾区立四ツ木斎場」（葛飾区四ツ木1-29-1）があります。火葬場を備えた公共施設で、葛飾区民の方がご利用いただける施設です。ご葬儀の場所選びや四ツ木斎場のご利用に関するご相談も、お気軽に稲垣屋葬儀店へお問い合わせください。なお、四ツ木斎場は葛飾区が管理する公共施設であり、稲垣屋葬儀店が運営しているわけではありません。
            </p>
            <p className="text-[#4a4a4a] text-base md:text-lg leading-loose mb-6">
              稲垣屋葬儀店は、四つ木から近い堀切（葛飾区堀切6-33-4）に拠点を置く地域密着の葬儀社です。明治11年頃の創業以来、葛飾区に根ざして地域の皆様のご葬儀をお手伝いしてきました。四つ木エリアのご家族からのご相談にも、すぐにお伺いできます。
            </p>
            <p className="text-[#4a4a4a] text-base leading-loose">
              家族葬・一日葬・火葬式・一般葬・区民葬儀など、ご家族のご希望に合わせた多様なプランをご用意しています。葛飾区民の方は区民葬儀制度のご利用も可能です。「どのプランが合うか相談したい」「費用の見当をつけたい」など、事前のご相談も無料で承っておりますので、どうぞお気軽にご連絡ください。24時間365日対応しております。
            </p>
          </FadeInUp>
      ...
      <section className="py-14 md:py-20 bg-white border-t border-[#e8ddf4]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <RelatedColumns slugs={["yotsugi-funeral", "horikiri-funeral", "katsushika-funeral-first-guide", "what-to-do-after-death-katsushika"]} />
        </div>
      </section>
