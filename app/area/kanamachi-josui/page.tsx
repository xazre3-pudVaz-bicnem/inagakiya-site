...
export const metadata: Metadata = {
  title: "金町・浄水場周辺の葬儀｜葛飾区 稲垣屋葬儀店",
  description:
    "金町・浄水場周辺で葬儀をお考えの方へ。葛飾区の稲垣屋葬儀店が家族葬・一日葬・火葬式・区民葬儀に対応。",
  alternates: {
    canonical: "https://www.inagakiyasougiten.com/area/kanamachi-josui",
  },
};

const faqs = [
  {
    q: "金町・浄水場周辺で急にご逝去があった場合、何時でも連絡できますか？",
    a: "はい、24時間365日いつでもご連絡いただけます。深夜・早朝・休日を問わず対応しております。金町・浄水場周辺のご自宅や病院へも速やかにお迎えに参ります。まずはお電話（03-3690-0870）ください。",
  },
  {
    q: "金町・浄水場周辺から稲垣屋葬儀店まではどのくらいですか？",
    a: "稲垣屋葬儀店は葛飾区堀切6-33-4にあります。金町・浄水場周辺からは車で20〜30分ほどの距離です。JR常磐線・京成金町線「金町」駅北側エリアからも、ご連絡いただければ速やかにお伺いします。",
  },
  {
    q: "金町・浄水場周辺での家族葬の費用はどのくらいですか？",
    a: "費用はご参列者の人数・プランの内容・ご利用の斎場などにより異なります。事前のお見積もりは無料です。近隣の斎場についてもご案内できますので、まずはお気軽にご相談ください。",
  },
  {
    q: "金町・浄水場周辺でも区民葬儀制度は使えますか？",
    a: "はい、ご利用いただけます。葛飾区の区民葬儀制度は、故人または喪主が葛飾区に住民票をお持ちの方が対象です。金町・浄水場周辺にお住まいの方も対象となります。稲垣屋葬儀店は区民葬儀取扱店として登録しています。",
  },
];
...
const webPageJsonLd = {
  ...
  "@type": "WebPage",
  name: "金町・浄水場周辺の葬儀｜葛飾区 稲垣屋葬儀店",
  description: "金町・浄水場周辺で葬儀をお考えの方へ。葛飾区の稲垣屋葬儀店が家族葬・一日葬・火葬式・区民葬儀に対応。",
  url: "https://www.inagakiyasougiten.com/area/kanamachi-josui",
  breadcrumb: {
    "@type": "BreadcrumbList",
    itemListElement: [
      { "@type": "ListItem", position: 1, name: "ホーム", item: "https://www.inagakiyasougiten.com" },
      { "@type": "ListItem", position: 2, name: "葛飾区 地域別葬儀情報", item: "https://www.inagakiyasougiten.com/area" },
      { "@type": "ListItem", position: 3, name: "金町・浄水場周辺の葬儀", item: "https://www.inagakiyasougiten.com/area/kanamachi-josui" },
    ],
  },
};

export default function KanamachiJosuiPage() {
  return (
    <>
      <script
      ...
      <PageHero
        title="金町・浄水場周辺の葬儀について"
        subtitle="葛飾区堀切の稲垣屋葬儀店がお迎えします"
        en="FUNERAL SERVICE"
      />
      <Breadcrumb
        items={[{ label: "対応エリア", href: "/area" }, { label: "金町・浄水場周辺の葬儀" }]}
      />
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <FadeInUp>
            <p className="text-[#4a4a4a] text-base md:text-lg leading-loose mb-6">
              金町の北側には東京都水道局の金町浄水場が位置しており、その周辺は葛飾区の住宅地として落ち着いた環境が広がっています。JR常磐線・京成金町線「金町」駅からほど近く、北に向かうとすぐに浄水場エリアに隣接する閑静な住まいが並んでいます。緑豊かな環境の中で長年暮らしてきたご家族が多いエリアです。
            </p>
            <p className="text-[#4a4a4a] text-base md:text-lg leading-loose mb-6">
              稲垣屋葬儀店は、葛飾区堀切6-33-4を拠点とする地域密着の葬儀社です。明治11年頃の創業以来、葛飾区全域の皆様のご葬儀をお手伝いしてきました。金町・浄水場周辺のご家族からのご連絡も、24時間365日いつでも承り、速やかにお伺いします。
            </p>
            <p className="text-[#4a4a4a] text-base md:text-lg leading-loose mb-6">
              「いざというときに葬儀社をどこに頼むか」を事前に決めておくと、ご家族の負担を大きく減らすことができます。稲垣屋葬儀店では、事前の無料相談を随時お受けしており、費用・プラン・斎場の選び方など、どんなことでも丁寧にご説明します。葬祭ディレクター1級のスタッフがご対応いたします。
            </p>
