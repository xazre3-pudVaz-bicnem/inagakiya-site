...
export const metadata: Metadata = {
  title: "水元の葬儀｜葛飾区 稲垣屋葬儀店",
  description:
    "水元で葬儀をお考えの方へ。葛飾区の稲垣屋葬儀店が家族葬・一日葬・火葬式・区民葬儀に対応。24時間365日対応。",
  alternates: {
    canonical: "https://www.inagakiyasougiten.com/area/mizumoto",
  },
};

const faqs = [
  {
    q: "水元で急にご逝去があった場合、何時でも連絡できますか？",
    a: "はい、24時間365日いつでもご連絡いただけます。深夜・早朝・休日を問わず対応しております。水元のご自宅や病院へも速やかにお迎えに参ります。まずはお電話（03-3690-0870）ください。",
  },
  {
    q: "水元から稲垣屋葬儀店まではどのくらいですか？",
    a: "稲垣屋葬儀店は葛飾区堀切6-33-4にあります。水元からは車で25〜35分ほどの距離です。葛飾区北部に位置する水元エリアからも、ご連絡いただければ速やかにお伺いいたします。",
  },
  {
    q: "水元での家族葬の費用はどのくらいですか？",
    a: "費用はご参列者の人数・プランの内容・ご利用の斎場などにより異なります。水元周辺の近隣の斎場についてもご案内できます。事前のお見積もりは無料ですので、まずはお気軽にご相談ください。",
  },
  {
    q: "水元でも区民葬儀制度は使えますか？",
    a: "はい、ご利用いただけます。葛飾区の区民葬儀制度は、故人または喪主が葛飾区に住民票をお持ちの方が対象です。水元にお住まいの方も対象となります。稲垣屋葬儀店は葛飾区の区民葬儀取扱店として登録しています。",
  },
];
...
const webPageJsonLd = {
  ...
  "@type": "WebPage",
  name: "水元の葬儀｜葛飾区 稲垣屋葬儀店",
  description: "水元で葬儀をお考えの方へ。葛飾区の稲垣屋葬儀店が家族葬・一日葬・火葬式・区民葬儀に対応。24時間365日対応。",
  url: "https://www.inagakiyasougiten.com/area/mizumoto",
  breadcrumb: {
    "@type": "BreadcrumbList",
    itemListElement: [
      { "@type": "ListItem", position: 1, name: "ホーム", item: "https://www.inagakiyasougiten.com" },
      { "@type": "ListItem", position: 2, name: "葛飾区 地域別葬儀情報", item: "https://www.inagakiyasougiten.com/area" },
      { "@type": "ListItem", position: 3, name: "水元から見た稲垣屋葬儀店", item: "https://www.inagakiyasougiten.com/area/mizumoto" },
    ],
  },
};

export default function MizumotoPage() {
  return (
    <>
      <script
      ...
      />
      <Breadcrumb
        items={[{ label: "対応エリア", href: "/area" }, { label: "水元の葬儀" }]}
      />
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <FadeInUp>
            <p className="text-[#4a4a4a] text-base md:text-lg leading-loose mb-6">
              水元は葛飾区の北部に位置し、都内最大級の水辺の公園「水元公園」で広く知られるエリアです。広大な池と豊かな緑が広がる自然環境の中で、落ち着いた住宅地が形成されています。「葛飾区の自然が残る場所」として、長年この地を住まいとしてきた方々が多くいらっしゃいます。
            </p>
            <p className="text-[#4a4a4a] text-base md:text-lg leading-loose mb-6">
              稲垣屋葬儀店は、葛飾区堀切6-33-4を拠点とする地域密着の葬儀社です。明治11年頃の創業以来、葛飾区全域の皆様のご葬儀をお手伝いしてきました。水元エリアのご家族からのご連絡も、24時間365日いつでも承り、速やかにお伺いします。
            </p>
            <p className="text-[#4a4a4a] text-base md:text-lg leading-loose mb-6">
              水元は葛飾区内でも比較的北に位置するため、「どこの葬儀社に頼めばよいか」と迷われる方もいらっしゃいます。稲垣屋葬儀店は葛飾区全域に対応しており、水元のご家族にも安心してご相談いただけます。葬祭ディレクター1級の資格を持つスタッフが、最初のご連絡から葬儀後まで、ご家族に寄り添ってサポートします。
            </p>
            <p className="text-[#4a4a4a] text-base leading-loose">
              家族葬・一日葬・火葬式・一般葬・区民葬儀と、ご家族の状況に合わせた多様なプランをご用意しています。葛飾区民の方は区民葬儀制度もご利用いただけます。事前相談・お見積もりはすべて無料です。どうぞお気軽にご連絡ください。
            </p>
          </FadeInUp>
      ...
      <section className="py-16 md:py-20 bg-[#faf7fd] border-t border-[#e8ddf4]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <StaggerContainer className="divide-y divide-[#e8ddf4]">
            {[
              { href: "/area/higashi-mizumoto", label: "東水元の葬儀" },
      ...
      <section className="py-14 md:py-20 bg-white border-t border-[#e8ddf4]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <RelatedColumns slugs={["mizumoto-funeral", "katsushika-funeral-first-guide", "what-to-do-after-death-katsushika"]} />
        </div>
      </section>
