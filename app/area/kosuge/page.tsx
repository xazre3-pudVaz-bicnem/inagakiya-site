...
export const metadata: Metadata = {
  title: "小菅の葬儀｜葛飾区 稲垣屋葬儀店",
  description:
    "小菅で葬儀をお考えの方へ。葛飾区の稲垣屋葬儀店が家族葬・一日葬・火葬式・区民葬儀に対応。24時間365日対応。",
  alternates: {
    canonical: "https://www.inagakiyasougiten.com/area/kosuge",
  },
};

const faqs = [
  {
    q: "小菅で急にご逝去があった場合、何時でも連絡できますか？",
    a: "はい、24時間365日いつでもご連絡いただけます。深夜・早朝・休日を問わず対応しております。小菅のご自宅や病院へも速やかにお迎えに参ります。まずはお電話（03-3690-0870）ください。",
  },
  {
    q: "小菅から稲垣屋葬儀店まではどのくらいですか？",
    a: "稲垣屋葬儀店は葛飾区堀切6-33-4にあります。小菅からは車で10〜15分ほどの距離です。葛飾区の西部に位置する小菅からも、ご連絡いただければ速やかにお伺いいたします。",
  },
  {
    q: "小菅での家族葬の費用はどのくらいですか？",
    a: "費用はご参列者の人数・プランの内容・ご利用の斎場などによって異なります。事前のお見積もりは無料です。まずはお気軽にご相談ください。費用の内訳を含めて丁寧にご説明いたします。",
  },
  {
    q: "小菅でも区民葬儀制度は使えますか？",
    a: "はい、ご利用いただけます。葛飾区の区民葬儀制度は、故人または喪主が葛飾区に住民票をお持ちの方が対象です。小菅にお住まいの方も対象となります。稲垣屋葬儀店は葛飾区の区民葬儀取扱店として登録しています。",
  },
];
...
const webPageJsonLd = {
  ...
  "@type": "WebPage",
  name: "小菅の葬儀｜葛飾区 稲垣屋葬儀店",
  description: "小菅で葬儀をお考えの方へ。葛飾区の稲垣屋葬儀店が家族葬・一日葬・火葬式・区民葬儀に対応。24時間365日対応。",
  url: "https://www.inagakiyasougiten.com/area/kosuge",
  breadcrumb: {
    "@type": "BreadcrumbList",
    itemListElement: [
      { "@type": "ListItem", position: 1, name: "ホーム", item: "https://www.inagakiyasougiten.com" },
      { "@type": "ListItem", position: 2, name: "葛飾区 地域別葬儀情報", item: "https://www.inagakiyasougiten.com/area" },
      { "@type": "ListItem", position: 3, name: "小菅の葬儀", item: "https://www.inagakiyasougiten.com/area/kosuge" },
    ],
  },
};

export default function KosugePage() {
  return (
    <>
      <script
      ...
      />
      <Breadcrumb
        items={[{ label: "対応エリア", href: "/area" }, { label: "小菅の葬儀" }]}
      />
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <FadeInUp>
            <p className="text-[#4a4a4a] text-base md:text-lg leading-loose mb-6">
              小菅は葛飾区の西部に位置する住宅地です。東京メトロ千代田線「北綾瀬」駅にも近く、足立区との境界付近に広がるエリアです。荒川に近い低地の住宅地として、古くからの地域コミュニティが残り、下町の温かみを感じる場所です。
            </p>
            <p className="text-[#4a4a4a] text-base md:text-lg leading-loose mb-6">
              稲垣屋葬儀店は、葛飾区堀切6-33-4を拠点とする地域密着の葬儀社です。小菅からは車で10〜15分ほどの距離にあります。明治11年頃の創業以来、葛飾区全域の皆様のご葬儀をお手伝いしてきました。小菅エリアのご家族からのご連絡も、24時間365日いつでも承り、速やかにお伺いします。
            </p>
            <p className="text-[#4a4a4a] text-base md:text-lg leading-loose mb-6">
              葬儀は、形式よりもご家族のお気持ちを大切にした場であるべきだと私どもは考えています。家族葬のような小規模なお別れでも、ご親族・ご友人が多く集まる一般葬でも、それぞれのご家族に合った形でお手伝いします。葬祭ディレクター1級の資格を持つスタッフが、ご希望をしっかりとお聞きします。
            </p>
