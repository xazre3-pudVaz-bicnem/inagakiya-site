...
export const metadata: Metadata = {
  title: "新宿（にいじゅく）の葬儀｜葛飾区 稲垣屋葬儀店",
  description:
    "葛飾区新宿（にいじゅく）で葬儀をお考えの方へ。稲垣屋葬儀店が家族葬・一日葬・火葬式・区民葬儀に対応。24時間365日対応。",
  alternates: {
    canonical: "https://www.inagakiyasougiten.com/area/niijuku",
  },
};

const faqs = [
  {
    q: "葛飾区新宿（にいじゅく）で急にご逝去があった場合、何時でも連絡できますか？",
    a: "はい、24時間365日いつでもご連絡いただけます。深夜・早朝・休日も問わず対応しております。葛飾区新宿（にいじゅく）のご自宅や病院へも速やかにお迎えに参ります。まずはお電話（03-3690-0870）ください。",
  },
  {
    q: "葛飾区新宿（にいじゅく）から稲垣屋葬儀店まではどのくらいですか？",
    a: "稲垣屋葬儀店は葛飾区堀切6-33-4にあります。葛飾区新宿（にいじゅく）からは車で15〜25分ほどの距離です。ご連絡いただければ速やかにお伺いいたします。",
  },
  {
    q: "葛飾区新宿（にいじゅく）での家族葬の費用はどのくらいですか？",
    a: "費用はご参列者の人数・プランの内容・ご利用の斎場などによって異なります。事前のお見積もりは無料です。まずはお気軽にご相談ください。費用の内訳も含めて丁寧にご説明いたします。",
  },
  {
    q: "葛飾区新宿（にいじゅく）でも区民葬儀制度は使えますか？",
    a: "はい、ご利用いただけます。葛飾区の区民葬儀制度は、故人または喪主が葛飾区に住民票をお持ちの方が対象です。葛飾区新宿（にいじゅく）にお住まいの方も対象となります。稲垣屋葬儀店は区民葬儀取扱店として登録しています。",
  },
];
...
const webPageJsonLd = {
  ...
  "@type": "WebPage",
  name: "新宿（にいじゅく）の葬儀｜葛飾区 稲垣屋葬儀店",
  description: "葛飾区新宿（にいじゅく）で葬儀をお考えの方へ。稲垣屋葬儀店が家族葬・一日葬・火葬式・区民葬儀に対応。24時間365日対応。",
  url: "https://www.inagakiyasougiten.com/area/niijuku",
  breadcrumb: {
    "@type": "BreadcrumbList",
    itemListElement: [
      { "@type": "ListItem", position: 1, name: "ホーム", item: "https://www.inagakiyasougiten.com" },
      { "@type": "ListItem", position: 2, name: "葛飾区 地域別葬儀情報", item: "https://www.inagakiyasougiten.com/area" },
      { "@type": "ListItem", position: 3, name: "新宿（にいじゅく）の葬儀", item: "https://www.inagakiyasougiten.com/area/niijuku" },
    ],
  },
};

export default function NiijukuPage() {
  return (
    <>
      <script
      ...
      <PageHero
        title="葛飾区新宿（にいじゅく）の葬儀について"
        subtitle="葛飾区堀切の稲垣屋葬儀店がお迎えします"
        en="FUNERAL SERVICE"
      />
      <Breadcrumb
        items={[{ label: "対応エリア", href: "/area" }, { label: "葛飾区新宿（にいじゅく）の葬儀" }]}
      />
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <FadeInUp>
            <p className="text-[#4a4a4a] text-base md:text-lg leading-loose mb-6">
              「新宿」という地名は東京では新宿区が有名ですが、葛飾区にも「新宿」という地名があります。読み方は「にいじゅく」といい、新宿区（しんじゅく）とはまったく異なる場所です。葛飾区新宿（にいじゅく）は、葛飾区内の落ち着いた住宅地であり、地元に長年根ざして暮らす方が多いエリアです。
            </p>
            <p className="text-[#4a4a4a] text-base md:text-lg leading-loose mb-6">
              稲垣屋葬儀店は、葛飾区堀切6-33-4を拠点とする地域密着の葬儀社です。明治11年頃の創業以来、葛飾区内の各地域で数多くのご葬儀をお手伝いしてきました。葛飾区新宿（にいじゅく）のご家族からのご連絡も、24時間365日いつでも承り、速やかにお伺いします。
            </p>
            <p className="text-[#4a4a4a] text-base md:text-lg leading-loose mb-6">
              「葛飾区新宿」という地名の珍しさから、他の地域の葬儀社に電話をしても対応できないと言われるケースも稀にあります。稲垣屋葬儀店は葛飾区全域を対象として対応しており、葛飾区新宿（にいじゅく）エリアのご家族にも安心してご相談いただけます。葬祭ディレクター1級のスタッフが丁寧に対応いたします。
            </p>
            <p className="text-[#4a4a4a] text-base leading-loose">
              家族葬・一日葬・火葬式・一般葬・区民葬儀と、ご家族の状況に合わせた多様なプランをご用意しています。葛飾区民の方は区民葬儀制度もご利用いただけます。事前相談・お見積もりはすべて無料です。お気軽にご連絡ください。
            </p>
          </FadeInUp>
      ...
      <section className="py-16 md:py-20 bg-[#faf7fd] border-t border-[#e8ddf4]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <StaggerContainer className="divide-y divide-[#e8ddf4]">
            {[
              { href: "/area/kameari", label: "亀有の葬儀" },
              { href: "/area/nishi-kameari", label: "西亀有の葬儀" },
              { href: "/area/takasago", label: "高砂の葬儀" },
