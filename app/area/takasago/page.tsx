...
const webPageJsonLd = {
  ...
  "@type": "WebPage",
  name: "高砂の葬儀｜葛飾区 稲垣屋葬儀店",
  description: "高砂で葬儀をお考えの方へ。葛飾区の稲垣屋葬儀店が家族葬・一日葬・火葬式・区民葬儀に対応。24時間365日対応。",
  url: "https://www.inagakiyasougiten.com/area/takasago",
  breadcrumb: {
    "@type": "BreadcrumbList",
    itemListElement: [
      { "@type": "ListItem", position: 1, name: "ホーム", item: "https://www.inagakiyasougiten.com" },
      { "@type": "ListItem", position: 2, name: "葛飾区 地域別葬儀情報", item: "https://www.inagakiyasougiten.com/area" },
      { "@type": "ListItem", position: 3, name: "高砂から見た稲垣屋葬儀店", item: "https://www.inagakiyasougiten.com/area/takasago" },
    ],
  },
};
    ...
    <>
      ...
      <section className="py-14 md:py-20 bg-white border-t border-[#e8ddf4]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <RelatedColumns slugs={["takasago-funeral", "katsushika-funeral-first-guide", "what-to-do-after-death-katsushika"]} />
        </div>
      </section>
