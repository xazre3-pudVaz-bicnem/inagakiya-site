...
const faqs = [
  {
    q: "柴又から稲垣屋葬儀店まではどのくらいかかりますか？",
    a: "稲垣屋葬儀店は葛飾区堀切6-33-4にあります。柴又エリアからは車で20分前後の距離です。京成金町線柴又駅周辺からのご連絡もお気軽にどうぞ。ご連絡をいただければ迅速に対応いたします。",
  },
  {
    q: "柴又で葬儀の事前相談はできますか？",
    a: "はい、事前相談は無料で承っております。「家族葬と一般葬の違いを知りたい」「費用の目安を教えてほしい」など、どんなことでもお気軽にお電話（03-3690-0870）またはお問い合わせフォームよりご連絡ください。",
  },
  {
    q: "柴又の方でも区民葬儀は利用できますか？",
    a: "はい、ご利用いただけます。区民葬儀は葛飾区民の方が対象の制度で、柴又にお住まいの方も対象となります。稲垣屋葬儀店は葛飾区の区民葬儀取扱店として登録しておりますので、詳しくはお気軽にお問い合わせください。",
  },
  {
    q: "柴又で急な葬儀にも対応していますか？",
    ...
    <>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <FadeInUp>
            <p className="text-[#4a4a4a] text-base md:text-lg leading-loose mb-6">
              京成金町線柴又駅を中心に広がる柴又は、柴又帝釈天（題経寺）で全国的に知られる歴史ある地域です。参道に続く下町情緒あふれる商店街や、江戸川の河川敷の緑、そして長年受け継がれてきた地域の文化が、今もこの町に息づいています。古くから多くの人々が暮らし、世代を超えてつながってきた柴又は、「地元のつながり」が今も大切にされているエリアです。
            </p>
            <p className="text-[#4a4a4a] text-base md:text-lg leading-loose mb-6">
              稲垣屋葬儀店は、明治11年頃の創業以来、葛飾区に根ざして地域の皆様のご葬儀をお手伝いしてまいりました。柴又の皆様が「地元の葬儀社に任せたい」とお考えの際には、どうぞ稲垣屋葬儀店にお声がけください。葛飾区堀切6-33-4の本店から、柴又エリアへも迅速にお伺いいたします。
            </p>
            <p className="text-[#4a4a4a] text-base md:text-lg leading-loose mb-6">
              ご葬儀は、故人様への最後のお気持ちを形にする大切な場です。稲垣屋葬儀店では、ご家族のご意向をていねいに伺いながら、家族葬・一日葬・火葬式・一般葬・区民葬儀など、ご希望に合った葬儀スタイルをご提案いたします。葬祭ディレクター1級を取得したスタッフが担当し、手続きから当日の進行まですべてをサポートします。
            </p>
            <p className="text-[#4a4a4a] text-base leading-loose">
              「急なことでどこに連絡すればよいかわからない」「まだ先のことだが、事前に相談しておきたい」など、どんなご状況でもお気軽にご連絡ください。事前相談は無料で承っております。24時間365日、柴又の皆様のご相談をお待ちしております。
            </p>
          </FadeInUp>
      ...
      <section className="py-14 md:py-20 bg-white border-t border-[#e8ddf4]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <RelatedColumns slugs={["shibamata-funeral", "kanamachi-funeral", "katsushika-funeral-first-guide", "what-to-do-after-death-katsushika"]} />
        </div>
      </section>
