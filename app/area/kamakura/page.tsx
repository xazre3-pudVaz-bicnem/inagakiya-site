...
export const metadata: Metadata = {
  title: "葛飾区鎌倉の葬儀｜稲垣屋葬儀店",
  description:
    "葛飾区鎌倉（かまくら）で葬儀をお考えの方へ。稲垣屋葬儀店が家族葬・一日葬・火葬式・区民葬儀に対応。24時間365日対応。",
  alternates: {
    canonical: "https://www.inagakiyasougiten.com/area/kamakura",
  },
};

const faqs = [
  {
    q: "葛飾区鎌倉で急にご逝去があった場合、何時でも連絡できますか？",
    a: "はい、24時間365日いつでもご連絡いただけます。葛飾区鎌倉（かまくら）のご自宅や病院へも速やかにお迎えに参ります。まずはお電話（03-3690-0870）ください。",
  },
  {
    q: "葛飾区鎌倉から稲垣屋葬儀店まではどのくらいですか？",
    a: "稲垣屋葬儀店は葛飾区堀切6-33-4にあります。葛飾区鎌倉からは車で15〜25分ほどの距離です。ご連絡いただければ、迅速にお伺いいたします。",
  },
  {
    q: "葛飾区鎌倉での家族葬の費用はどのくらいですか？",
    a: "費用はご参列者の人数・プランの内容・ご利用の斎場などにより異なります。事前のお見積もりは無料です。まずはお気軽にご相談ください。費用の内訳を含めて丁寧にご説明します。",
  },
  {
    q: "葛飾区鎌倉でも区民葬儀制度は使えますか？",
    a: "はい、ご利用いただけます。葛飾区鎌倉（かまくら）にお住まいの方も、故人または喪主が葛飾区に住民票をお持ちであれば区民葬儀制度の対象となります。稲垣屋葬儀店は葛飾区の区民葬儀取扱店として登録しています。",
  },
];
...
const webPageJsonLd = {
  ...
  "@type": "WebPage",
  name: "葛飾区鎌倉の葬儀｜稲垣屋葬儀店",
  description: "葛飾区鎌倉（かまくら）で葬儀をお考えの方へ。稲垣屋葬儀店が家族葬・一日葬・火葬式・区民葬儀に対応。24時間365日対応。",
  url: "https://www.inagakiyasougiten.com/area/kamakura",
  breadcrumb: {
    "@type": "BreadcrumbList",
    itemListElement: [
      { "@type": "ListItem", position: 1, name: "ホーム", item: "https://www.inagakiyasougiten.com" },
      { "@type": "ListItem", position: 2, name: "葛飾区 地域別葬儀情報", item: "https://www.inagakiyasougiten.com/area" },
      { "@type": "ListItem", position: 3, name: "葛飾区鎌倉の葬儀", item: "https://www.inagakiyasougiten.com/area/kamakura" },
    ],
  },
};
...
export default function KamakuraPage() {
  return (
    <>
      ...
      />
      <Breadcrumb
        items={[{ label: "対応エリア", href: "/area" }, { label: "葛飾区鎌倉の葬儀" }]}
      />
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <FadeInUp>
            <p className="text-[#4a4a4a] text-base md:text-lg leading-loose mb-6">
              「葛飾区鎌倉」（かまくら）は、神奈川県の鎌倉市とは全く別の、東京都葛飾区内の地名です。同じ読みの地名として珍しい存在ですが、葛飾区内で暮らす方々にとっては馴染みの深い住宅地です。静かな生活環境の中、地域のつながりを大切にしながら暮らす方々が多くいらっしゃいます。
            </p>
            <p className="text-[#4a4a4a] text-base md:text-lg leading-loose mb-6">
              稲垣屋葬儀店は、葛飾区堀切6-33-4を拠点とする地域密着の葬儀社です。明治11年頃の創業以来、葛飾区各地の皆様のご葬儀をお手伝いしてきました。葛飾区鎌倉エリアのご家族からのご連絡も、24時間365日いつでも承り、速やかにお伺いします。
            </p>
            <p className="text-[#4a4a4a] text-base md:text-lg leading-loose mb-6">
              急なご逝去の際も、事前のご相談でも、どうぞ遠慮なくお電話ください。葬祭ディレクター1級の資格を持つスタッフが、最初のご連絡からご葬儀後のアフターフォローまで、ご家族の側に寄り添ってサポートします。「葛飾区鎌倉では斎場がどこにあるか」「どんな葬儀形式が合うか」といったご質問にも丁寧にお答えします。
            </p>
