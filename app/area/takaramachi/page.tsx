...
export const metadata: Metadata = {
  title: "宝町の葬儀｜葛飾区 稲垣屋葬儀店",
  description:
    "宝町で葬儀をお考えの方へ。葛飾区の稲垣屋葬儀店が家族葬・一日葬・火葬式・区民葬儀に対応。24時間365日対応。",
  alternates: {
    canonical: "https://www.inagakiyasougiten.com/area/takaramachi",
  },
};

const faqs = [
  {
    q: "宝町で急にご逝去があった場合、何時でも連絡できますか？",
    a: "はい、24時間365日いつでもご連絡いただけます。深夜・早朝・休日を問わず対応しております。宝町のご自宅や病院へも速やかにお迎えに参ります。まずはお電話（03-3690-0870）ください。",
  },
  {
    q: "宝町から稲垣屋葬儀店まではどのくらいですか？",
    a: "稲垣屋葬儀店は葛飾区堀切6-33-4にあります。宝町からは車で15〜25分ほどの距離です。ご連絡いただければ速やかにお伺いいたします。",
  },
  {
    q: "宝町での家族葬の費用はどのくらいですか？",
    a: "費用はご参列者の人数・プランの内容・ご利用の斎場などによって異なります。事前のお見積もりは無料です。費用の内訳を含めて丁寧にご説明しますので、まずはお気軽にご相談ください。",
  },
  {
    q: "宝町でも区民葬儀制度は使えますか？",
    a: "はい、ご利用いただけます。葛飾区の区民葬儀制度は、故人または喪主が葛飾区に住民票をお持ちの方が対象です。宝町にお住まいの方も対象となります。稲垣屋葬儀店は葛飾区の区民葬儀取扱店として登録しています。",
  },
];
...
const webPageJsonLd = {
  ...
  "@type": "WebPage",
  name: "宝町の葬儀｜葛飾区 稲垣屋葬儀店",
  description: "宝町で葬儀をお考えの方へ。葛飾区の稲垣屋葬儀店が家族葬・一日葬・火葬式・区民葬儀に対応。24時間365日対応。",
  url: "https://www.inagakiyasougiten.com/area/takaramachi",
  breadcrumb: {
    "@type": "BreadcrumbList",
    itemListElement: [
      { "@type": "ListItem", position: 1, name: "ホーム", item: "https://www.inagakiyasougiten.com" },
      { "@type": "ListItem", position: 2, name: "葛飾区 地域別葬儀情報", item: "https://www.inagakiyasougiten.com/area" },
      { "@type": "ListItem", position: 3, name: "宝町の葬儀", item: "https://www.inagakiyasougiten.com/area/takaramachi" },
    ],
  },
};

export default function TakaramachiPage() {
  return (
    <>
      <script
      ...
      />
      <Breadcrumb
        items={[{ label: "対応エリア", href: "/area" }, { label: "宝町の葬儀" }]}
      />
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <FadeInUp>
            <p className="text-[#4a4a4a] text-base md:text-lg leading-loose mb-6">
              宝町は葛飾区内の住宅地の一つです。葛飾区の落ち着いた住環境の中、地元のつながりを大切にしながら暮らすご家族が多くいらっしゃいます。こうした地域では、「いざというとき、どの葬儀社に頼めばよいか」を事前に知っておきたいという方も多くいらっしゃいます。
            </p>
            <p className="text-[#4a4a4a] text-base md:text-lg leading-loose mb-6">
              稲垣屋葬儀店は、葛飾区堀切6-33-4を拠点とする地域密着の葬儀社です。明治11年頃の創業以来、葛飾区各地の皆様のご葬儀をお手伝いしてきました。宝町エリアのご家族からのご連絡も、24時間365日いつでも承り、速やかにお伺いします。
            </p>
            <p className="text-[#4a4a4a] text-base md:text-lg leading-loose mb-6">
              急なご逝去の場合も、事前の相談でも、どちらでも対応しております。「病院で亡くなった場合の流れを知りたい」「自宅で最期を迎えた場合はどうすればよいか」「葬儀の費用が心配」など、どんな疑問もお気軽にご相談ください。葬祭ディレクター1級の資格を持つスタッフが丁寧にお答えします。
            </p>
