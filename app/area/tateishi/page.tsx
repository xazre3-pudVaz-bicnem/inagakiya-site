...
export const metadata: Metadata = {
  title: "立石で葬儀のご相談なら稲垣屋葬儀店｜葛飾区の地域密着葬儀社",
  description:
    "葛飾区立石周辺で葬儀をご検討の方へ。稲垣屋葬儀店は葛飾区堀切に拠点を置く地域密着の葬儀社。立石エリアにも対応。家族葬・一日葬・区民葬儀に対応。",
  alternates: { canonical: "https://www.inagakiyasougiten.com/area/tateishi" },
};

const faqs = [
  {
    q: "立石から稲垣屋葬儀店まではどのくらいかかりますか？",
    a: "稲垣屋葬儀店は葛飾区堀切6-33-4にあります。立石エリアからは車で10〜15分ほどの距離です。京成押上線立石駅周辺からもスムーズにお伺いできますので、ご連絡をいただければ迅速に対応いたします。",
  },
  {
    q: "立石で葬儀の事前相談はできますか？",
    a: "はい、事前相談は無料で承っております。「家族葬か一般葬か迷っている」「費用の目安を知りたい」など、どんなことでもお気軽にお電話（03-3690-0870）またはお問い合わせフォームよりご連絡ください。",
  },
  {
    q: "立石の方でも区民葬儀は利用できますか？",
    a: "はい、ご利用いただけます。区民葬儀は葛飾区民の方が対象の制度です。立石にお住まいの方も対象となります。稲垣屋葬儀店は葛飾区の区民葬儀取扱店として登録しておりますので、詳しくはお気軽にお問い合わせください。",
  },
  {
    q: "立石で急な葬儀にも対応していますか？",
...
const webPageJsonLd = {
  ...
  "@type": "WebPage",
  name: "立石で葬儀のご相談なら稲垣屋葬儀店｜葛飾区の地域密着葬儀社",
  description: "葛飾区立石周辺で葬儀をご検討の方へ。稲垣屋葬儀店は葛飾区堀切に拠点を置く地域密着の葬儀社。立石エリアにも対応。家族葬・一日葬・区民葬儀に対応。",
  url: "https://www.inagakiyasougiten.com/area/tateishi",
  breadcrumb: {
    "@type": "BreadcrumbList",
    itemListElement: [
      { "@type": "ListItem", position: 1, name: "ホーム", item: "https://www.inagakiyasougiten.com" },
      { "@type": "ListItem", position: 2, name: "葛飾区 地域別葬儀情報", item: "https://www.inagakiyasougiten.com/area" },
      { "@type": "ListItem", position: 3, name: "立石から見た稲垣屋葬儀店", item: "https://www.inagakiyasougiten.com/area/tateishi" },
    ],
  },
};

export default function TateishiPage() {
  return (
    <>
      <script
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <FadeInUp>
            <p className="text-[#4a4a4a] text-base md:text-lg leading-loose mb-6">
              京成押上線立石駅周辺に広がる立石は、活気ある商店街と昔ながらの下町情緒が入り混じる、葛飾区の中でも特に個性的なエリアです。長年にわたって地域の方々が行き交い、地元への愛着が深い方が多く暮らしています。そうした土地柄から、「葬儀は地元をよく知る葬儀社に任せたい」というお気持ちをお持ちの方も多くいらっしゃいます。
            </p>
            <p className="text-[#4a4a4a] text-base md:text-lg leading-loose mb-6">
              稲垣屋葬儀店は、立石から近い堀切（葛飾区堀切6-33-4）に拠点を置く地域密着の葬儀社です。明治11年頃の創業以来、葛飾区に根ざし、地域の皆様のご葬儀をお手伝いしてまいりました。立石エリアのご家族からのご相談にも、すぐに対応できる体制を整えております。
            </p>
            <p className="text-[#4a4a4a] text-base md:text-lg leading-loose mb-6">
              葬儀のご依頼は急なことが多く、どこに連絡すればよいか迷うことも多いと思います。稲垣屋葬儀店では、ご逝去直後のお迎えから、ご遺体のご安置、葬儀の手配、アフターフォローまで、ご家族の側に立ってすべてをサポートいたします。葬祭ディレクター1級を取得したスタッフが丁寧に対応し、ご家族のご要望に合わせたプランをご提案いたします。
            </p>
            <p className="text-[#4a4a4a] text-base leading-loose">
              家族葬・一日葬・火葬式・一般葬・区民葬儀など、多様な葬儀プランをご用意しています。また、葛飾区民の方であれば区民葬儀制度をご利用いただくことも可能です。「どのプランが合うかわからない」という場合も、まずはお気軽にご相談ください。24時間365日、立石の皆様のご連絡をお待ちしております。
            </p>
          </FadeInUp>
      ...
      <section className="py-14 md:py-20 bg-white border-t border-[#e8ddf4]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <RelatedColumns slugs={["tateishi-funeral", "katsushika-funeral-first-guide", "what-to-do-after-death-katsushika"]} />
        </div>
      </section>
