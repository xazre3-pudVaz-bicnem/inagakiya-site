...
export const metadata: Metadata = {
  title: "白鳥の葬儀｜葛飾区 稲垣屋葬儀店",
  description:
    "白鳥で葬儀をお考えの方へ。葛飾区の稲垣屋葬儀店が家族葬・一日葬・火葬式・区民葬儀に対応。24時間365日対応。",
  alternates: {
    canonical: "https://www.inagakiyasougiten.com/area/shiratori",
  },
};

const faqs = [
  {
    q: "白鳥で急にご逝去があった場合、何時でも連絡できますか？",
    a: "はい、24時間365日いつでもご連絡いただけます。深夜・早朝・休日を問わず対応しております。白鳥のご自宅や病院へも速やかにお迎えに参ります。まずはお電話（03-3690-0870）ください。",
  },
  {
    q: "白鳥から稲垣屋葬儀店まではどのくらいですか？",
    a: "稲垣屋葬儀店は葛飾区堀切6-33-4にあります。白鳥からは車で15〜20分ほどの距離です。葛飾区南部の白鳥エリアからもスムーズにお伺いできますので、お気軽にご連絡ください。",
  },
  {
    q: "白鳥での家族葬の費用はどのくらいですか？",
    a: "費用はご参列者の人数・プランの内容・ご利用の斎場などによって異なります。事前のお見積もりは無料です。費用の内訳も含めて丁寧にご説明しますので、まずはお気軽にご相談ください。",
  },
  {
    q: "白鳥でも区民葬儀制度は使えますか？",
    a: "はい、ご利用いただけます。葛飾区の区民葬儀制度は、故人または喪主が葛飾区に住民票をお持ちの方が対象です。白鳥にお住まいの方も対象となります。稲垣屋葬儀店は葛飾区の区民葬儀取扱店として登録しています。",
  },
];
...
const webPageJsonLd = {
  ...
  "@type": "WebPage",
  name: "白鳥の葬儀｜葛飾区 稲垣屋葬儀店",
  description: "白鳥で葬儀をお考えの方へ。葛飾区の稲垣屋葬儀店が家族葬・一日葬・火葬式・区民葬儀に対応。24時間365日対応。",
  url: "https://www.inagakiyasougiten.com/area/shiratori",
  breadcrumb: {
    "@type": "BreadcrumbList",
    itemListElement: [
      { "@type": "ListItem", position: 1, name: "ホーム", item: "https://www.inagakiyasougiten.com" },
      { "@type": "ListItem", position: 2, name: "葛飾区 地域別葬儀情報", item: "https://www.inagakiyasougiten.com/area" },
      { "@type": "ListItem", position: 3, name: "白鳥の葬儀", item: "https://www.inagakiyasougiten.com/area/shiratori" },
    ],
  },
};

export default function ShiratoriPage() {
  return (
    <>
      <script
      ...
      />
      <Breadcrumb
        items={[{ label: "対応エリア", href: "/area" }, { label: "白鳥の葬儀" }]}
      />
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <FadeInUp>
            <p className="text-[#4a4a4a] text-base md:text-lg leading-loose mb-6">
              白鳥は葛飾区の南部に位置する住宅地です。葛飾区の中でも穏やかな雰囲気のエリアで、長年この地に暮らしてきたご家族が多くいらっしゃいます。地元に根ざした生活を送る方が多く、「いざというとき、信頼できる地元の葬儀社に頼みたい」というお気持ちをお持ちの方も少なくありません。
            </p>
            <p className="text-[#4a4a4a] text-base md:text-lg leading-loose mb-6">
              稲垣屋葬儀店は、葛飾区堀切6-33-4を拠点とする地域密着の葬儀社です。明治11年頃の創業以来、葛飾区全域の皆様のご葬儀をお手伝いしてきました。白鳥エリアのご家族からのご連絡も、24時間365日いつでも承り、速やかにお伺いします。
            </p>
            <p className="text-[#4a4a4a] text-base md:text-lg leading-loose mb-6">
              「急に亡くなってしまい、何をすればよいか」「通夜・葬儀の費用はどのくらいかかるか」「家族葬と一般葬の違いは何か」など、どんな疑問でも葬祭ディレクター1級の資格を持つスタッフが丁寧にお答えします。はじめての葬儀で不安を感じていらっしゃる方も、どうかご遠慮なくご相談ください。
            </p>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <StaggerContainer className="divide-y divide-[#e8ddf4]">
            {[
              ...
              { href: "/area/takaramachi", label: "宝町の葬儀" },
