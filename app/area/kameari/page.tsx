...
export const metadata: Metadata = {
  ...
  description:
    "葛飾区亀有周辺で葬儀をご検討の方へ。稲垣屋葬儀店は葛飾区に根付く地域密着の葬儀社。亀有エリアからのご相談もお気軽に。24時間365日対応。",
  alternates: { canonical: "https://www.inagakiyasougiten.com/area/kameari" },
};

const faqs = [
  {
    q: "亀有から稲垣屋葬儀店まではどのくらいかかりますか？",
    a: "稲垣屋葬儀店は葛飾区堀切6-33-4にあります。亀有エリアからは車で15〜20分ほどの距離です。JR常磐線（各停）亀有駅周辺からもお伺いできますので、ご連絡をいただければ迅速に対応いたします。",
  },
  {
    q: "亀有で葬儀の事前相談はできますか？",
    a: "はい、事前相談は無料で承っております。「将来のために葬儀について知っておきたい」「家族でどんな葬儀にするか話し合いたい」など、お気軽にお電話（03-3690-0870）またはお問い合わせフォームよりご連絡ください。",
  },
  {
    q: "亀有の方でも区民葬儀は利用できますか？",
    a: "はい、ご利用いただけます。区民葬儀は葛飾区民の方が対象の制度で、亀有にお住まいの方も対象となります。稲垣屋葬儀店は葛飾区の区民葬儀取扱店として登録しておりますので、詳しくはお気軽にお問い合わせください。",
  },
  {
    q: "亀有で急な葬儀にも対応していますか？",
...
const webPageJsonLd = {
  ...
  "@type": "WebPage",
  name: "亀有で葬儀のご相談なら稲垣屋葬儀店｜葛飾区の地域密着葬儀社",
  description: "葛飾区亀有周辺で葬儀をご検討の方へ。稲垣屋葬儀店は葛飾区に根付く地域密着の葬儀社。亀有エリアからのご相談もお気軽に。24時間365日対応。",
  url: "https://www.inagakiyasougiten.com/area/kameari",
  breadcrumb: {
    "@type": "BreadcrumbList",
    itemListElement: [
      { "@type": "ListItem", position: 1, name: "ホーム", item: "https://www.inagakiyasougiten.com" },
      { "@type": "ListItem", position: 2, name: "葛飾区 地域別葬儀情報", item: "https://www.inagakiyasougiten.com/area" },
      { "@type": "ListItem", position: 3, name: "亀有から見た稲垣屋葬儀店", item: "https://www.inagakiyasougiten.com/area/kameari" },
    ],
  },
};

export default function KameariPage() {
  return (
    <>
      <script
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <FadeInUp>
            <p className="text-[#4a4a4a] text-base md:text-lg leading-loose mb-6">
              JR常磐線（各停）亀有駅を中心に広がる亀有は、葛飾区の東部に位置するエリアです。下町の温かみが今も色濃く残るこの地域は、長年にわたって地域のつながりを大切にしながら暮らしてきた方が多く、地元の商店や施設に愛着を持つ方も少なくありません。葬儀においても「地元をよく知る葬儀社に任せたい」というお気持ちはとても自然なことです。
            </p>
            <p className="text-[#4a4a4a] text-base md:text-lg leading-loose mb-6">
              稲垣屋葬儀店は、葛飾区堀切6-33-4を拠点とする地域密着の葬儀社です。明治11年頃の創業以来、葛飾区に根ざして地域の皆様のご葬儀をお手伝いしてまいりました。亀有エリアからのご相談にも、真摯にお応えいたします。
            </p>
            <p className="text-[#4a4a4a] text-base md:text-lg leading-loose mb-6">
              大切な方をお送りする葬儀は、ご家族にとってかけがえのない時間です。稲垣屋葬儀店では、ご逝去直後のお迎えから、ご安置・葬儀の手配・アフターフォローまで、ご家族に寄り添いながらすべてをサポートします。葬祭ディレクター1級を取得したスタッフがていねいに対応し、ご家族のご希望やご状況に合わせた最適なプランをご提案いたします。
            </p>
            <p className="text-[#4a4a4a] text-base leading-loose">
              「急に連絡が必要になったが、どこに電話すればよいかわからなかった」という声をよくいただきます。どうぞ、まず稲垣屋葬儀店にお電話ください（03-3690-0870）。ご状況をお伺いしながら、最善の対応をご案内いたします。亀有の皆様のご相談を、24時間365日お待ちしております。
            </p>
          </FadeInUp>
